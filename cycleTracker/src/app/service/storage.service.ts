...
export class StorageService {
  ...
  private initStorageFromJSON(): void {
    this.storage.create().then((val) => {
      ...
      records.push(new Record(18712, 3, 0));
      records.push(new Record(18713, 3, 0));
      records.push(new Record(18722, 3, 0));
      ...
      records.push(new Record(18735, 3, 1));
      records.push(new Record(18736, 3, 0));
      records.push(new Record(18737, 3, 0));
      records.push(new Record(18751, 3, 0));
      records.push(new Record(18752, 3, 0));
      records.push(new Record(18753, 3, 0));
      ...
      records.push(new Record(18777, 3, 0));
      records.push(new Record(18778, 3, 0));
      records.push(new Record(18786, 3, 0));
      records.push(new Record(18787, 3, 0));
      records.push(new Record(18793, 3, 0));
      records.push(new Record(18800, 2, 0));
      records.push(new Record(18801, 2, 0));
      records.push(new Record(18802, 2, 0));
      records.push(new Record(18803, 2, 0));
